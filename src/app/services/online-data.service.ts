  ...
  getSpinData() : Promise<Response> {
    ...
    return fetch(url, {
      ...
      headers: {
        ...
        Authorization: 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1bmlxdWVfbmFtZSI6IlNwaW4iLCJuYmYiOjE1NTE2OTA0MzAsImV4cCI6MTU4MzMxMjc4OCwiaWF0IjoxNTUxNjkwNDMwLCJpc3MiOiJTcGluIn0.0ZYOjrkF-biXdrH-78rzH_jqsYlnFjznLtuWzZVTO-Y'
      },
